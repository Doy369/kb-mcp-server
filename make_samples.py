...
document_xml = (
    ...
    '<w:p><w:r><w:t>核心服务可用性承诺：企业版 99.95%，标准版 99.9%；对应月度故障时长不超过 21.9 分钟。</w:t></w:r></w:p>'
    '<w:p><w:r><w:t>工单响应：P0 紧急 15 分钟内响应，P1 高危 1 小时，P2 普通 4 小时。</w:t></w:r></w:p>'
    '<w:p><w:r><w:t>赔付标准：月度可用性低于承诺值，按不足比例补偿服务时长，最高补偿当月费用的 30%。</w:t></w:r></w:p>'
    '<w:p><w:r><w:t>维护窗口：常规维护安排在凌晨 02:00-04:00，提前 24 小时通知。</w:t></w:r></w:p>'
    '</w:body></w:document>'
)
content_types = (
    '<?xml version="1.0"?>'
